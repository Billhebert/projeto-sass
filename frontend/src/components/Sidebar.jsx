...
function Sidebar() {
  ...
  const { isCollapsed, isMobileOpen, toggleCollapse, toggleMobileMenu, closeMobileMenu } = useSidebarStore()
  ...
  const isInSection = (paths) => paths.some(p => location.pathname.startsWith(p))
  ...
  const menuSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { path: '/sales-dashboard', label: 'Dashboard Vendas', icon: 'analytics' },
        ...
        { path: '/profit-calculator', label: 'Calculadora Lucro', icon: 'calculate' },
      ]
    },
    {
      title: 'Atendimento',
    ...
    },
    {
      ...
      items: [
        ...
        { path: '/price-automation', label: 'Automacao Precos', icon: 'price_change' },
    ...
    },
    {
      ...
      key: 'system',
      items: [
        { path: '/notifications', label: 'Notificacoes', icon: 'notifications_none' },
  ...
  const renderSection = (section, index) => {
    const isSectionExpanded = !section.key || expandedSections[section.key] !== false || isInSection(section.items.map(i => i.path))
    ...
    <>
      ...
      <aside className={`sidebar ${isCollapsed ? 'collapsed' : ''} ${isMobileOpen ? 'mobile-open' : ''}`}>
        ...
        <div className="sidebar-header">
          ...
          {!isMobile && (
            <button className="collapse-btn" onClick={toggleCollapse} aria-label="Colapsar menu">
