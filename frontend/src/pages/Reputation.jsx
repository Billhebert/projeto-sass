...
function Reputation() {
  ...
  const generateHistoricalTrend = (rep) => {
    ...
    return months.map((month, idx) => ({
      ...
      vendas: Math.max(
        0,
        Math.floor((baseCompleted / 6) * (1 + (idx - 3) * 0.1)),
      ),
      reclamacoes: Math.max(0, baseClaims + (Math.random() - 0.5) * 2).toFixed(
        1,
      ),
  ...
  const getMetricStatus = (value, thresholds) => {
    if (value <= thresholds.good)
      return { status: "good", color: "#10b981", label: "Otimo" };
    if (value <= thresholds.warning)
      return { status: "warning", color: "#f59e0b", label: "Atencao" };
      ...
      <div className="thermometer-container">
        ...
        <div className="thermometer-center">
          <span
            ...
            style={{ color: level.color, fontSize: "2.5rem" }}
          >
            {level.icon}
          </span>
  ...
  const cancellationRate =
    (reputation?.metrics?.cancellations?.rate || 0) * 100;
  ...
  const cancellationStatus = getMetricStatus(cancellationRate, {
    good: 2,
    warning: 5,
  });
      ...
      {reputation && (
        <>
          ...
          <section className="level-section">
            ...
            >
              <div className="level-thermometer">{renderThermometer()}</div>
            ...
            <div className="metrics-grid">
              ...
              <div className={`metric-card ${claimsStatus.status}`}>
                <div className="metric-header">
                  ...
                  <span className={`metric-badge ${claimsStatus.status}`}>
                    {claimsStatus.label}
                  </span>
                </div>
                <div className="metric-body">
                  ...
                  <div className="metric-bar">
                    <div
                      ...
                      style={{
                        width: `${Math.min(claimsRate * 10, 100)}%`,
                        background: claimsStatus.color,
                      }}
                    ></div>
                  </div>
                ...
                <div className="metric-details">
                  ...
                  <div className="detail-row">
                    ...
                    <span>
                      {reputation.metrics?.claims?.period || "Ultimos 60 dias"}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className={`metric-card ${delayedStatus.status}`}>
                <div className="metric-header">
                  ...
                  <span className={`metric-badge ${delayedStatus.status}`}>
                    {delayedStatus.label}
                  </span>
                </div>
                <div className="metric-body">
                  ...
                  <span className="metric-label">
                    Taxa de Atrasos no Despacho
                  </span>
                  <div className="metric-bar">
                    <div
                      className="metric-bar-fill"
                      style={{
                        width: `${Math.min(delayedRate * 5, 100)}%`,
                        background: delayedStatus.color,
                      }}
                    ></div>
                  </div>
                  <p className="metric-help">
                ...
                <div className="metric-details">
                  <div className="detail-row">
                    ...
                    <span>
                      {reputation.metrics?.delayed_handling_time?.value || 0}
                    </span>
                  </div>
                  <div className="detail-row">
                    <span>Periodo Analisado</span>
                    <span>
                      {reputation.metrics?.delayed_handling_time?.period ||
                        "Ultimos 60 dias"}
                    </span>
                  </div>
                </div>
              ...
              <div className={`metric-card ${cancellationStatus.status}`}>
                <div className="metric-header">
                  ...
                  <span className={`metric-badge ${cancellationStatus.status}`}>
                ...
                <div className="metric-body">
                  ...
                  <div className="metric-bar">
                    <div
                      className="metric-bar-fill"
                      style={{
                        width: `${Math.min(cancellationRate * 10, 100)}%`,
                        background: cancellationStatus.color,
                      }}
                    ></div>
                  </div>
                  <p className="metric-help">
                ...
                <div className="metric-details">
                  ...
                  <div className="detail-row">
                    <span>Periodo Analisado</span>
                    <span>
                      {reputation.metrics?.cancellations?.period ||
                        "Ultimos 60 dias"}
                    </span>
                  </div>
                </div>
            ...
            <div className="tips-grid">
              <div className="tip-card">
                ...
                <div className="tip-content">
                  ...
                  <p>
                    Envie seus produtos dentro do prazo para manter uma boa taxa
                    de despacho.
                  </p>
              ...
              <div className="tip-card">
                ...
                <div className="tip-content">
                  ...
                  <p>
                    Responda perguntas e mensagens rapidamente para evitar
                    reclamacoes.
                  </p>
              ...
              <div className="tip-card">
                ...
                <div className="tip-content">
                  ...
                  <p>
                    Mantenha seu estoque atualizado para evitar cancelamentos
              ...
              <div className="tip-card">
                ...
                <div className="tip-content">
                  ...
                  <p>
                    Crie anuncios detalhados com boas fotos e descricoes para
                    evitar duvidas.
                  </p>
            ...
            <section className="protection-section">
              <div className="protection-card">
                ...
                <div className="protection-content">
                  ...
                  <p>
                    Voce esta em um periodo de protecao. Algumas metricas
                    negativas nao afetarao sua reputacao ate{" "}
                    {new Date(
                      reputation.protection.end_date,
