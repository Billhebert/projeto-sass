...
function Questions() {
  ...
  const [answerModal, setAnswerModal] = useState({ show: false, question: null })
  ...
  const loadQuestions = async () => {
    ...
    setError(null)
    try {
      const endpoint = filter === 'unanswered' 
  ...
  const submitAnswer = async () => {
    ...
    setSubmitting(true)
    try {
      await api.post(`/questions/${selectedAccount}/${answerModal.question.mlQuestionId}/answer`, {
        text: answerText
      })
      closeAnswerModal()
      await loadQuestions()
      ...
      {stats && (
        <div className="stats-grid">
          ...
          <div className="stat-card">
            ...
            <div className="stat-info">
              <span className="stat-value">{stats.avgResponseTime || 'N/A'}</span>
      ...
      <div className="questions-list">
        {loading ? (
          ...
          questions.map(question => (
            <div key={question._id || question.mlQuestionId} className="question-card">
              <div className="question-header">
                <div className="question-product">
                  {question.item?.thumbnail && (
                    <img src={question.item.thumbnail} alt="" className="product-thumb" />
                  )}
                  <div className="product-info">
                    <span className="product-title">{question.item?.title || 'Produto'}</span>
