...
function Trends() {
  ...
  const loadCategoryTrends = async () => {
    ...
    try {
      ...
      setCategoryTrends(generateMockCategoryTrends())
    } finally {
      setLoading(false)
    }
  }
  ...
  const generateMockTrends = () => {
    ...
    return mockProducts.sort((a, b) => b.volume - a.volume)
  }
  ...
  const generateMockCategoryTrends = () => {
    ...
    return baseProducts.map((name, idx) => ({
  ...
  const chartData = filteredTrends.slice(0, 10).map(t => ({
    name: t.keyword.length > 20 ? t.keyword.substring(0, 20) + '...' : t.keyword,
    volume: t.volume,
    growth: t.growth
  }))
            ...
            <div className="overview-grid">
              <div className="trend-highlight hot">
                ...
                <div className="highlight-content">
                  ...
                  <span className="highlight-value">{filteredTrends[0]?.keyword || 'N/A'}</span>
                  <span className="highlight-volume">{formatVolume(filteredTrends[0]?.volume || 0)} buscas</span>
                </div>
              </div>
              ...
              <div className="trend-highlight growing">
                ...
                <div className="highlight-content">
                  ...
                  <span className="highlight-value">
                    {filteredTrends.sort((a, b) => b.growth - a.growth)[0]?.keyword || 'N/A'}
                  </span>
                  <span className="highlight-growth positive">
                    +{filteredTrends.sort((a, b) => b.growth - a.growth)[0]?.growth.toFixed(1) || 0}%
                  </span>
                </div>
              </div>
              ...
              <div className="trend-highlight total">
                ...
                <div className="highlight-content">
                  ...
                  <span className="highlight-value">{filteredTrends.length}</span>
              ...
              <div className="chart-body">
                <ResponsiveContainer width="100%" height={350}>
                  <BarChart data={chartData} layout="vertical">
                    ...
                    <XAxis type="number" tickFormatter={formatVolume} stroke="#9ca3af" fontSize={11} />
                    <YAxis type="category" dataKey="name" width={150} stroke="#9ca3af" fontSize={11} />
                    <Tooltip 
                      formatter={(value) => [formatVolume(value), 'Volume']}
                      contentStyle={{ backgroundColor: '#fff', border: '1px solid #e5e7eb', borderRadius: '8px' }}
                    />
                    <Bar dataKey="volume" radius={[0, 4, 4, 0]} fill="#3b82f6" />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </div>
                    ...
                    <tr key={idx}>
                      ...
                      <td className="keyword-cell">
                        <div className="keyword-content">
                          ...
                          {idx < 3 && (
                            <span className="material-icons fire-icon">local_fire_department</span>
                          )}
                        </div>
                      </td>
                      <td className="category-cell">
                        <span className="category-badge">{trend.category || 'Geral'}</span>
                      </td>
                      <td className="volume-cell">
                        <span className="volume">{formatVolume(trend.volume)}</span>
                        <span className="volume-label">buscas/mes</span>
                      </td>
                      <td className="growth-cell">
                        <div className="growth-indicator" style={{ color: getGrowthColor(trend.growth) }}>
                          <span className="material-icons">{getGrowthIcon(trend.growth)}</span>
          ...
          <section className="opportunities-section">
                ...
                .map((trend, idx) => (
                  <div key={idx} className="opportunity-card">
                    <div className="opportunity-header">
                      ...
                      <span className="opportunity-growth" style={{ color: getGrowthColor(trend.growth) }}>
                        <span className="material-icons">trending_up</span>
                        +{trend.growth.toFixed(1)}%
                      </span>
                    </div>
                    <h4 className="opportunity-keyword">{trend.keyword}</h4>
                    <p className="opportunity-volume">{formatVolume(trend.volume)} buscas mensais</p>
                    <div className="opportunity-actions">
                      <Link to="/items/create" className="btn btn-sm btn-primary">
            ...
            {filteredTrends.filter(t => t.growth > 15).length === 0 && (
              <div className="no-opportunities">
                ...
                <p>Nenhuma oportunidade de alto crescimento encontrada no momento.</p>
              </div>
            )}
          </section>
          ...
          <section className="tips-section">
            ...
            <div className="tips-grid">
              <div className="tip-card">
                ...
                <p>Produtos com alto volume de buscas indicam grande demanda. Priorize esses nichos.</p>
              </div>

              <div className="tip-card">
                <div className="tip-number">2</div>
                <h4>Observe o Crescimento</h4>
                <p>Tendencias em alta (verde) sao oportunidades. Tendencias em queda podem ser arriscadas.</p>
              </div>

              <div className="tip-card">
                <div className="tip-number">3</div>
                <h4>Pesquise a Concorrencia</h4>
                <p>Antes de criar anuncios, veja quantos vendedores ja oferecem o produto.</p>
              </div>

              <div className="tip-card">
                <div className="tip-number">4</div>
                <h4>Otimize seus Titulos</h4>
                <p>Use as palavras-chave em tendencia nos titulos dos seus anuncios para melhor visibilidade.</p>
              </div>
            </div>
          </section>
        </>
