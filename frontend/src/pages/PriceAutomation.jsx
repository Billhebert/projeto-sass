    ...
    <div className="price-automation-page">
      <div className="page-header">
        <div className="header-content">
          ...
          <p>
            Crie regras automaticas para ajustar precos baseado em concorrentes,
            margem e outros criterios
          </p>
        </div>
      ...
      {!selectedAccount ? (
        <div className="empty-state">
          ...
          <p>
            Selecione uma conta do Mercado Livre para gerenciar as regras de
            automacao de precos
          </p>
        </div>
      ) : (
        ...
        <div className="modal-overlay" onClick={() => setShowModal(false)}>
          ...
          >
            <div className="modal-header">
              <h2>
                {editingRule ? "Editar Regra" : "Nova Regra de Precificacao"}
              </h2>
              <button
                className="btn btn-icon"
            ...
            <div className="modal-body">
              <div className="form-section">
                ...
                <div className="form-group">
                  ...
                  >
                    ...
                    <option value="margin_protection">
                      Protecao de Margem
                    </option>
                ...
                <div className="form-row">
                  <div className="form-group">
                    ...
                    >
                      ...
                      <option value="set_min_margin">
                        Definir margem minima
                      </option>
              ...
              <div className="form-section">
                ...
                <p className="items-selected">
                  {formData.items.length} produtos selecionados
                </p>
              </div>
            </div>
