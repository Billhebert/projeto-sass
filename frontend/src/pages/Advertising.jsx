            ...
            <div className="kpi-grid">
              ...
              <div className="kpi-card conversions">
                ...
                <div className="kpi-content">
                  ...
                  <span className="kpi-sub">
                    CPC: {formatCurrency(stats.avgCpc || 0)}
                  </span>
                </div>
              </div>
              ...
              <div className="kpi-card roi">
                ...
                <div className="kpi-content">
                  ...
                  <span
                    className="kpi-value"
                    style={{ color: stats.roi > 0 ? "#10b981" : "#ef4444" }}
                  >
                    {stats.roi > 0 ? "+" : ""}
          ...
          <section className="tips-section">
            ...
            <div className="tips-grid">
              <div className="tip-card">
                ...
                <p>
                  Use palavras-chave relevantes para atingir compradores
                  interessados.
                </p>
              </div>
              ...
              <div className="tip-card">
                ...
                <p>
                  Comece com lances mais altos e ajuste conforme os resultados.
                </p>
              </div>
              ...
              <div className="tip-card">
                ...
                <p>
                  Acompanhe as metricas e pause campanhas que nao performam.
                </p>
              </div>
                  ...
                  {(Array.isArray(items) ? items : []).map((item) => (
                    <tr key={item.id}>
                      ...
                      <td>
                        <span
                          style={{
                            color: (item.roas || 0) > 1 ? "#10b981" : "#ef4444",
                          }}
                        >
                      ...
                      <td>
                        <div className="action-buttons">
                          ...
                          <button
                            className="btn-icon"
                            title={
                              item.adStatus === "active" ? "Pausar" : "Ativar"
                            }
                          >
                            <span className="material-icons">
          ...
          >
            ...
            <div className="modal-footer">
              ...
              <button
                ...
                disabled={
                  !createForm.name ||
                  (!createForm.dailyBudget && !createForm.totalBudget)
                }
              >
              ...
              <div className="campaign-detail-stats">
                ...
                <div className="detail-stat highlight">
                  ...
                  <span
                    className="value"
                    style={{
                      color: selectedCampaign.roas > 1 ? "#10b981" : "#ef4444",
                    }}
                  >
