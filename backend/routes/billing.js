...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      const totalFees =
        totalMarketplaceFee + totalShippingFee + totalFinancingFee;
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      const dailySummary = Object.values(dailyData).sort((a, b) =>
